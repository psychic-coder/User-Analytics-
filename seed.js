/**
 * Seed Script — inserts demo analytics data directly into MongoDB
 * Bypasses the API rate limiter entirely.
 * Usage: node seed.js
 */
...
// ─── Event Schema (mirrors apps/server/src/models/Event.ts) ─────────────────
